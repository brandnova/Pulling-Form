...
urlpatterns = [
    ...
    path('edit-custom-page/', views.edit_custom_page, name='edit_custom_page'),
    path('add-form-field/', views.add_form_field, name='add_form_field'),
    path('edit-form-field/<int:field_id>/', views.edit_form_field, name='edit_form_field'),
    path('delete-form-field/<int:field_id>/', views.delete_form_field, name='delete_form_field'),
    path('reorder-form-fields/', views.reorder_form_fields, name='reorder_form_fields'),
